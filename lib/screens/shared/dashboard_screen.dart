...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Ticket? _selectedTicketForDetail; // Untuk melacak tiket yang sedang dibuka di tab
  ...
  Widget _getSelectedScreen() {
    ...
    switch (_selectedIndex) {
      ...
      case 1:
        // Jika sedang di tab tiket dan ada tiket yang dipilih (khusus staff), tampilkan detail
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          setState(() {
            ...
            _selectedTicketForDetail = null; // Reset detail jika pindah tab
          });
        },
        items: [
